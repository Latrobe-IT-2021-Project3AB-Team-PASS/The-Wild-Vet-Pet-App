...
class Medication : AppCompatActivity() {
    ...
    val petList: MutableList<Medication_pet> = mutableListOf()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        println(petList)
        // 自定义 适配器
        val MedicationList: MedicationList = MedicationList(this,petList)
        lvList.setAdapter(MedicationList)
