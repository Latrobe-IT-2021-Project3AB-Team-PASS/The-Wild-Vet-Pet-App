...
class VaccinationDetailPlus : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val textView4 = findViewById<View>(R.id.textView18) as TextView
        val textView5 = findViewById<View>(R.id.textView19) as TextView
        textView1.text = bundle!!.getString("vacctype")
        textView2.text = bundle.getString("Vaccdate")
        textView3.text = bundle.getString("vaccproductname")
